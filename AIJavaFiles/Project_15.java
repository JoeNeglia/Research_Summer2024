...
**Note:**
- Ensure you have set up Firebase properly in your Android project as Firebase authentication is being used.
- This file contains basic implementations for each feature described in the project prompts. For a full-scale project, each activity would typically be expanded, tested, and integrated with a Firebase real-time database or Firestore for complete backend functionalities.
- UI design files (XML layouts), icons, and other resources are not included here but should be created corresponding to these activities.
- For the sake of brevity, many advanced features such as score calculation, detailed data privacy handling, rich UI/UX designs, and API integrations are simplified or provided with placeholders. 

Make sure to replace placeholders with actual functional code as per your project's specifications and design requirements.