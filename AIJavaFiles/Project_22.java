...
// The layouts (XML files) must be created accordingly:
...
<LinearLayout
    ...
    <Button
        android:id="@+id/science_category_button"
        android:layout_width="match_parent"
        android:layout_height="wrap_content"
        android:text="Science" />

    <Button
        android:id="@+id/history_category_button"
        android:layout_width="match_parent"
        android:layout_height="wrap_content"
        android:text="History" />

    <Button
        android:id="@+id/pop_culture_category_button"
        android:layout_width="match_parent"
        android:layout_height="wrap_content"
        android:text="Pop Culture" />

    <Button
        android:id="@+id/technology_category_button"
        android:layout_width="match_parent"
        android:layout_height="wrap_content"
...
// File: res/layout/activity_quiz.xml
/*
<LinearLayout
    xmlns:android="http://schemas.android.com/apk/res/android"
    android:layout_width="match_parent"
...
// Note: Services for Firestore, Push Notifications, and other API integrations will need corresponding setup. This example keeps it local and basic for demonstration purposes.