...
def calculate_metrics(java_code):
    ...
    return (percent_code, percent_whitespace, percent_comments, percent_imports,
            average_variable_name_length, average_method_name_length, average_lines_per_method, import_count)
...
def process_java_files(input_folder, output_folder):
    ...
    combined_output_file = os.path.join(output_folder, 'both_imports.csv')
